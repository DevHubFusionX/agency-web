...
export const projects = [
  {
    ...
    solution: 'We utilized React Native for a seamless mobile experience and a highly scalable backend with Redis for real-time messaging and AWS for media storage.',
    ...
    technologies: ['React Native', 'Firebase', 'Redis', 'Node.js', 'AWS S3'],
    image: sparkDating,
    timeline: '14 weeks',
